...
var createClickHandlers = function createClickHandlers(click, dblClick) {
  ...
  var onDoubleClick = dblClick ? function (e) {
    clearTimeout(timeoutId);
    dblClick(e);
  } : undefined;
...
export { PluginHost, EventEmitter, memoize, shallowEqual, argumentsShallowEqual, getMessagesFormatter, createClickHandlers, easeInQuad, easeOutQuad, easeInOutQuad, easeInCubic, easeOutCubic, easeInOutCubic, easeInQuart, easeOutQuart, easeInOutQuart, easeInQuint, easeOutQuint, easeInOutQuint };
